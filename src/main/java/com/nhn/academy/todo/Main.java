                ...
                switch (input) {
                    ...
                    case "2":
                        ...
                        while (a == true) {
                            ...
                            System.out.println("5. 마감 조회");
                            System.out.println("6. 미완료 조회");
                            ...
                            switch (input2) {
                                ...
                                case "4":
                                    ...
                                    String input2_4 = reader.readLine();
                                    List<Todo> result = service.searchByTitle(input2_4);
                                    service.printSearchResult(result, "제목 검색");
                                    break;
                                case "5":
                                    System.out.print("마감 (1:오늘 마감, 2:이번 주 마감) > ");
                                    String input2_5 = reader.readLine();
                                    switch (input2_5) {
                                        case "1":
                                            List<Todo> todayTodos = service.getDueToday();
                                            service.printSearchResult(todayTodos, "오늘 마감");
                                            break;
                                        case "2":
                                            List<Todo> incomplete = service.filterByDone(false);
                                            service.printSearchResult(incomplete, "미완료");
                                            break;
                                        default:
                                            System.out.println("잘못된 입력입니다.");
                                            break;
